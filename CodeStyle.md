...
- `backend`: Contains docker files, .env files and files necessary for git.
  ...
  - `backend_django`: Contains source code
    ...
    - `services`: Capsule classes for handling local and remote services like ID Management, Database access and much more
