...
from code_SemperKI.handlers.public.websocket import fireWebsocketEventForClient
...
def verificationOfProcess(processObj:Process, session): # ProcessInterface not needed, verification is database only
    ...
    try:
        ...
        fireWebsocketEventForClient(processObj.project.projectID, [processObj.processID], ProcessUpdates.processStatus)  
