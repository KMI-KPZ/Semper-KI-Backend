...
class TestPackaging(TestCase):
    ...
    def createOrganization(self, client:Client, id="", userID = ""):
        ...
        client.patch("/"+paths["updateDetailsOfOrga"][0], data={"changes": { "supportedServices": [5] } }, content_type="application/json")
        return mockSession
    ...
    def test_getContractors(self):
        ...
        # # set service type to 5
        # changes = {"projectID": projectObj[ProjectDescription.projectID], "processIDs": [processObj[ProcessDescription.processID]], "changes": { "serviceType": 5}, "deletions":{} }
