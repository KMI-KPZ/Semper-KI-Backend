...
class FilterP():
    ...
    ##################################################
    def filterPContractors(self, processObj:ProcessInterface|Process) -> list|Exception:
        """
        ...
        try:
            ...
            loggerError.error(f"Error in filterPContractors: {e}")
            raise e
    ...
    def getFilteredContractors(self, processObj:ProcessInterface|Process) -> dict:
        ...
        """
        try:
            listOfContractors = self.filterPContractors(processObj)
