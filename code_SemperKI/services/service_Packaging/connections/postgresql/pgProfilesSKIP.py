...
from ...definitions import OrganizationDetailsP

from logging import getLogger
logger = getLogger("errors")

####################################################################################
def updateUserDetailsSemperKIP(userHashID:str, session):
    """
...
####################################################################################
def updateOrgaDetailsSemperKIP(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in updateOrgaDetailsSemperKIP: {str(e)}")

####################################################################################
def deleteOrgaDetailsSemperKIP(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in deleteOrgaDetailsSemperKIP: {str(e)}")