...
def initializeService(serviceDetails:dict) -> dict:
    ...
    try:
        ...
        logger.error(f'Generic error in initializeService(Delivery): {str(error)}')
...
def updateServiceDetails(existingContent, newContent) -> dict:
    ...
    try:
        ...
        logger.error(f'Generic error in updateServiceDetails(Delivery): {str(error)}')
...
def isFileRelevantForService(existingContent:dict, fileID:str) -> bool:
    ...
    try:
        ...
        logger.error(f'Generic error in isFileRelevantForService(Delivery): {str(error)}')
        return False
...
def serviceReady(existingContent:dict) -> tuple[bool, list[str]]:
    ...
    try:
        ...
        logger.error(f'Generic error in serviceReady(Delivery): {str(error)}')
        return False
...
def cloneServiceDetails(existingContent:dict, newProcess:Process|ProcessInterface) -> dict:
    ...
    try:
        ...
        logger.error(f'Generic error in cloneServiceDetails(Delivery): {str(error)}')
