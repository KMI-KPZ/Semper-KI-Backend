...
from ...definitions import OrganizationDetailsD

from logging import getLogger
logger = getLogger("errors")

####################################################################################
def updateUserDetailsSemperKID(userHashID:str, session):
    """
...
####################################################################################
def updateOrgaDetailsSemperKID(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in updateOrgaDetailsSemperKID: {str(e)}")

####################################################################################
def deleteOrgaDetailsSemperKID(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in deleteOrgaDetailsSemperKID: {str(e)}")