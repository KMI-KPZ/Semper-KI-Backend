...
from ...definitions import OrganizationDetailsQC

from logging import getLogger
logger = getLogger("errors")

####################################################################################
def updateUserDetailsSemperKIQC(userHashID:str, session):
    """
...
####################################################################################
def updateOrgaDetailsSemperKIQC(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in updateOrgaDetailsSemperKIQC: {str(e)}")

####################################################################################
def deleteOrgaDetailsSemperKIQC(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in deleteOrgaDetailsSemperKIQC: {str(e)}")