...
from ..connections.postgresql.pgProfilesSKIQC import updateOrgaDetailsSemperKIQC, deleteOrgaDetailsSemperKIQC

################################################################################################

class QualityControlSignalReceivers():
    """
    ...
    def receiverForOrgaServiceSelection(sender, **kwargs):
        ...
        for service in selectedServices:
            if service == SERVICE_NUMBER:
                updateOrgaDetailsSemperKIQC(orgaID)
    ...
    def receiverForOrgaServiceDeletion(sender, **kwargs):
        ...
        for service in selectedServices:
            if service == SERVICE_NUMBER:
                deleteOrgaDetailsSemperKIQC(orgaID)
...
qualityControlSignalReceiver = QualityControlSignalReceivers()
