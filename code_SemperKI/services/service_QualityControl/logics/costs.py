...
from ..connections.filterViaSparql import FilterQC
...
class Costs():
    ...
    ##################################################
    def __init__(self, process:ProcessInterface|Process, additionalArguments:dict, filterObject:FilterQC) -> None:
        """
