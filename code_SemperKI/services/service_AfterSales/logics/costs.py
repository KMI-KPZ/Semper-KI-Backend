...
from ..connections.filterViaSparql import FilterAS
...
class Costs():
    ...
    ##################################################
    def __init__(self, process:ProcessInterface|Process, additionalArguments:dict, filterObject:FilterAS) -> None:
        """
