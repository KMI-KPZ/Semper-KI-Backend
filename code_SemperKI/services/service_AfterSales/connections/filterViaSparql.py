...
class Filter():
    ...
    ##################################################
    def filterASContractors(self, processObj:ProcessInterface|Process) -> list|Exception:
        """
        ...
        try:
            ...
            loggerError.error(f"Error in filterASContractors: {e}")
            raise e
    ...
    def getFilteredContractors(self, processObj:ProcessInterface|Process) -> dict:
        ...
        """
        try:
            listOfContractors = self.filterASContractors(processObj)
