...
####################################################################################
def updateUserDetailsSemperKIAS(userHashID:str, session):
    """
...
####################################################################################
def updateOrgaDetailsSemperKIAS(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in updateOrgaDetailsSemperKIAS: {str(e)}")

####################################################################################
def deleteOrgaDetailsSemperKIAS(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in deleteOrgaDetailsSemperKIAS: {str(e)}")