...
class TestAfterSales(TestCase):
    ...
    def createOrganization(self, client:Client, id="", userID = ""):
        ...
        client.patch("/"+paths["updateDetailsOfOrga"][0], data={"changes": { "supportedServices": [7] } }, content_type="application/json")
        return mockSession
    ...
    def test_getContractors(self):
        ...
        # # set service type to 7
        # changes = {"projectID": projectObj[ProjectDescription.projectID], "processIDs": [processObj[ProcessDescription.processID]], "changes": { "serviceType": 7}, "deletions":{} }
