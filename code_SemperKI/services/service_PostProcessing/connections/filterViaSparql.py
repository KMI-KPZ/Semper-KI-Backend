...
class Filter():
    ...
    ##################################################
    def filterPPContractors(self, processObj:ProcessInterface|Process) -> list|Exception:
        """
        ...
        try:
            ...
            loggerError.error(f"Error in filterPPContractors: {e}")
            raise e
    ...
    def getFilteredContractors(self, processObj:ProcessInterface|Process) -> dict:
        ...
        """
        try:
            listOfContractors = self.filterPPContractors(processObj)
