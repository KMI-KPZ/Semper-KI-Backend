...
class Filter():
    ...
    ##################################################
    def filterCMContractors(self, processObj:ProcessInterface|Process) -> list|Exception:
        """
        ...
        try:
            ...
            loggerError.error(f"Error in filterCMContractors: {e}")
            raise e
    ...
    def getFilteredContractors(self, processObj:ProcessInterface|Process) -> dict:
        ...
        """
        try:
            listOfContractors = self.filterCMContractors(processObj)
