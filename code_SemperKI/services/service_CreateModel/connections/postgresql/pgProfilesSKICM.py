...
from ...definitions import OrganizationDetailsCM

from logging import getLogger
logger = getLogger("errors")

####################################################################################
def updateUserDetailsSemperKICM(userHashID:str, session):
    """
...
####################################################################################
def updateOrgaDetailsSemperKICM(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in updateOrgaDetailsSemperKICM: {str(e)}")

####################################################################################
def deleteOrgaDetailsSemperKICM(orgaHashID:str):
    """
    ...
    try:
        ...
        logger.error(f"Error in deleteOrgaDetailsSemperKICM: {str(e)}")