...
def initializeService(serviceDetails:dict) -> dict:
    ...
    try:
        ...
        logger.error(f'Generic error in initializeService(Create Model): {str(error)}')
...
def updateServiceDetails(existingContent, newContent) -> dict:
    ...
    try:
        ...
        logger.error(f'Generic error in updateServiceDetails(Create Model): {str(error)}')
...
def isFileRelevantForService(existingContent:dict, fileID:str) -> bool:
    ...
    try:
        ...
        logger.error(f'Generic error in isFileRelevantForService(Create Model): {str(error)}')
        return False
...
def serviceReady(existingContent:dict) -> tuple[bool, list[str]]:
    ...
    try:
        ...
        logger.error(f'Generic error in serviceReady(Create Model): {str(error)}')
        return False
...
def cloneServiceDetails(existingContent:dict, newProcess:Process|ProcessInterface) -> dict:
    ...
    try:
        ...
        logger.error(f'Generic error in cloneServiceDetails(Create Model): {str(error)}')
